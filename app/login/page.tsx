      ...
      >
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight">NXT Khanza</h1>
            <p className="text-white/50 mt-2">Sistem Informasi Manajemen Rumah Sakit</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-white/70 ml-1">ID User / NIK</label>
